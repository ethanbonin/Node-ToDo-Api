...
describe('GET /todos/ids', () => {
  ...
  it('should not get single Doc by another user', (done) => {
    request(app)
...
describe('DELETE /todos/:id', () => {
  ...
  it('should not be able remove a todo that is not your own', (done) => {
    var hexID = todos[1]._id.toHexString();
    request(app)
    .delete(`/todos/${hexID}`)
    .set('x-auth', users[0].tokens[0].token)
...
describe('PATCH /todos/:id', () => {
  ...
  it('should not be able update the todo that is not yours', (done) => {
    var hexID = todos[1]._id.toHexString();
    var text = 'This should be the new test';
